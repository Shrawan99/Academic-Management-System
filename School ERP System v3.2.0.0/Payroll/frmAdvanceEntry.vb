...
Public Class frmAdvanceEntry
    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con.Close()
            LedgerSave(dtpEntryDate.Value.Date, txtStaffName.Text, txtID.Text, "Payroll Advance", Val(txtAmount.Text), 0, txtStaffID.Text)
            GetData()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub btnUpdate_Click(sender As System.Object, e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            btnUpdate.Enabled = False
            con.Close()
            LedgerUpdate(dtpEntryDate.Value.Date, txtStaffName.Text, Val(txtAmount.Text), 0, txtStaffID.Text, txtID.Text, "Payroll Advance")
            GetData()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub DeleteRecord()
        Try
            ...
            If RowsAffected > 0 Then
                LedgerDelete(txtID.Text, "Payroll Advance")
