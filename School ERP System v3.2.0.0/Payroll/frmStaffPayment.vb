...
Public Class frmStaffPayment
    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If paymentmode.SelectedIndex = 0 Then
                LedgerSave(PaymentDate.Value.Date, "Cash Account", PaymentID.Text, "Payment", Val(NetPay.Text), 0, StaffID.Text)
            End If
            If paymentmode.SelectedIndex = 1 Or paymentmode.SelectedIndex = 2 Then
                LedgerSave(PaymentDate.Value.Date, "Bank Account", PaymentID.Text, "Payment", Val(NetPay.Text), 0, StaffID.Text)
            End If
            Print()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btnUpdate_Click(sender As System.Object, e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            con.Close()
            If paymentmode.SelectedIndex = 0 Then
                LedgerUpdate(PaymentDate.Value.Date, "Cash Account", Val(NetPay.Text), 0, StaffID.Text, PaymentID.Text, "Payment")
            End If
            If paymentmode.SelectedIndex = 1 Or paymentmode.SelectedIndex = 2 Then
                LedgerUpdate(PaymentDate.Value.Date, "Bank Account", Val(NetPay.Text), 0, StaffID.Text, PaymentID.Text, "Payment")
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub Deduction_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs) Handles Deduction.KeyPress
        Dim keyChar = e.KeyChar

        If Char.IsControl(keyChar) Then
            'Allow all control characters.
        ElseIf Char.IsDigit(keyChar) OrElse keyChar = "."c Then
            Dim text = Me.Deduction.Text
            Dim selectionStart = Me.Deduction.SelectionStart
            Dim selectionLength = Me.Deduction.SelectionLength
