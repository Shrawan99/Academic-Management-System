...
Public Class frmPartialDueList_Students
    ...
    Private Sub cmbSession_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cmbSession.SelectedIndexChanged
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim ct As String = "SELECT distinct RTRIM(Student_Class) FROM CourseFeePayment where CourseFeePayment.Session=@d1 order by 1"
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT distinct RTRIM(Student.AdmissionNo),RTRIM(GRNo),RTRIM(StudentName),RTRIM(SchoolName),RTRIM(PaymentDue) from Student,CourseFeePayment,SchoolInfo,CourseFeePayment_Join where Student.AdmissionNo=CourseFeePayment.AdmissionNo and Student.SchoolID=SchoolInfo.S_ID and CourseFeePayment.CFP_ID=CourseFeePayment_Join.C_PaymentID and CourseFeePayment.Session=@d1 and CourseFeePayment.Student_Class=@d2 and Month=@d3 and PaymentDue > 0 order by 3", con)
            cmd.Parameters.AddWithValue("@d1", cmbSession.Text)
    ...
    Private Sub cmbClass_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cmbClass.SelectedIndexChanged
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim ct As String = "SELECT distinct RTRIM(Month) FROM CourseFeePayment,CourseFeePayment_Join where CourseFeePayment.Session=@d1 and CourseFeePayment.Student_Class=@d2 and CourseFeePayment.CFP_ID=CourseFeePayment_Join.C_PaymentID order by 1"
            cmd = New SqlCommand(ct)
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", cmbSession.Text)
            cmd.Parameters.AddWithValue("@d2", cmbClass.Text)
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT distinct RTRIM(Student.AdmissionNo),RTRIM(GRNo),RTRIM(StudentName),RTRIM(SchoolName),(PaymentDue) from Student,CourseFeePayment,SchoolInfo,CourseFeePayment_Join where Student.AdmissionNo=CourseFeePayment.AdmissionNo and Student.SchoolID=SchoolInfo.S_ID and CourseFeePayment.CFP_ID=CourseFeePayment_Join.C_PaymentID and CourseFeePayment.Session=@d1 and CourseFeePayment.Student_Class=@d2 and Month=@d3 and PaymentDue > 0 order by 3", con)
            cmd.Parameters.AddWithValue("@d1", cmbSession.Text)
            cmd.Parameters.AddWithValue("@d2", cmbClass.Text)
            cmd.Parameters.AddWithValue("@d3", cmbMonth.Text)
            ...
            ds.WriteXmlSchema("ClassFeePartialDue1.xml")
            Dim rpt As New rptClassFeePartialDue
            rpt.SetDataSource(ds)
            rpt.SetParameterValue("p1", cmbSession.Text)
            rpt.SetParameterValue("p2", cmbClass.Text)
            rpt.SetParameterValue("p3", cmbMonth.Text)
