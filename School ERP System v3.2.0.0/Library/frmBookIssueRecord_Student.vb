...
Public Class frmBookIssueRecord_Student
    Public Sub GetData()
        Try
        ...
        Try
            If dgw.Rows.Count > 0 Then
                ...
                If lblSet.Text = "Book Issue" Then
                    ...
                    frmBookIssue.txtID.Text = dr.Cells(0).Value.ToString()
                    frmBookIssue.txtAccessionNo.Text = dr.Cells(1).Value.ToString()
                    frmBookIssue.txtBookTitle.Text = dr.Cells(2).Value.ToString()
                    frmBookIssue.txtAuthor.Text = dr.Cells(3).Value.ToString()
                    frmBookIssue.txtJointAuthor.Text = dr.Cells(4).Value.ToString()
                    frmBookIssue.txtAdmissionNo.Text = dr.Cells(5).Value.ToString()
                    frmBookIssue.txtStudentName.Text = dr.Cells(6).Value.ToString()
                    frmBookIssue.txtClass.Text = dr.Cells(7).Value.ToString()
                    frmBookIssue.dtpIssueDate.Text = dr.Cells(8).Value.ToString()
                    frmBookIssue.dtpDueDate.Text = dr.Cells(9).Value.ToString()
                    frmBookIssue.txtStatus.Text = dr.Cells(10).Value.ToString()
                    frmBookIssue.txtRemarks.Text = dr.Cells(11).Value.ToString()
                    frmBookIssue.btnUpdate.Enabled = True
                    frmBookIssue.btnDelete.Enabled = True
                    frmBookIssue.btnSave.Enabled = False
                    frmBookIssue.Button1.Enabled = False
                    frmBookIssue.Button2.Enabled = False
