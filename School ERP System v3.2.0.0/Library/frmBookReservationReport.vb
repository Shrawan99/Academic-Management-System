...
Public Class frmBookReservationReport
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            con.Open()
            cmd = New SqlCommand("Select Book.AccessionNo,BookTitle,Author,StaffName,R_Date from Book,BookReservation,Staff where Book.AccessionNo=BookReservation.AccessionNo and BookReservation.StaffID=Staff.St_ID and R_Date between @d1 and @d2 order by R_Date", con)
            ...
            ds.WriteXmlSchema("BookReservationReport.xml")
            Dim rpt As New rptBookReservation
