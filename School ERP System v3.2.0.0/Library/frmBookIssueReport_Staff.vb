...
Public Class frmBookIssueReport_Staff
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            ...
            con.Open()
            cmd = New SqlCommand("Select Book.AccessionNo,Book.BookTitle,StaffName,IssueDate,DueDate from Book,BookIssue_Staff,Staff where Book.AccessionNo=BookIssue_Staff.AccessionNo and BookIssue_Staff.StaffID=Staff.St_ID and BookIssue_Staff.Status='Issued' and IssueDate between @d1 and @d2 order by IssueDate", con)
            ...
            ds.WriteXmlSchema("BookIssueReport_Staff.xml")
            Dim rpt As New rptBookIssue_Staff
