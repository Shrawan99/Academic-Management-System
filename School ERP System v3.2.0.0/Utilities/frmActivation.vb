    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If txtActivationID.Text = TextBox1.Text Then
                ...
                Me.Hide()
            Else
                'MessageBox.Show("Invalid activation id...Please contact software provider for buying full licence" & vbCrLf & "Contact us at :" & vbCrLf & "Shrawan Raut" & vbCrLf & "Email-shrawan.raut@ultimateway.space" & vbCrLf & "Mobile No. 9779800010556", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                MessageBox.Show("Invalid activation id...Please contact software provider for buying full licence" & vbCrLf & "Contact us at :" & vbCrLf & "Ultimate Way Pvt Ltd" & vbCrLf & "Email-info@ultimateway.space" & vbCrLf & "Mobile No. 9849866268", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
