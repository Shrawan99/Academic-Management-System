...
Public Class frmActiveHostelerRecord
    Sub fillSession()
        Try
        ...
        Try
            If dgw.Rows.Count > 0 Then
                ...
                If lblSet.Text = "Hostel Fee Payment" Then
                    ...
                    If rdr.Read() Then
                        frmHostelFeePayment.txtContactNo.Text = rdr.GetValue(0)
                    End If
    ...
    Public Sub GetData()
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(Hosteler.H_ID) as [ID],RTRIM(Student.AdmissionNo) as [Admission No.], RTRIM(StudentName) as [StudentName], RTRIM(ClassName) as [Class], RTRIM(SectionName) as Section,RTRIM(SchoolName) as [School Name],RTRIM(HI_ID) as [Hostel ID],RTRIM(HostelName) as [Hostel Name], CONVERT(DateTime,JoiningDate,105) as [Joining Date],RTRIM(Hosteler.Status) as [Status] from Student,Hosteler,HostelInfo,Section,Class,SchoolInfo where Student.SectionID=Section.ID  and HostelInfo.HI_ID=Hosteler.HostelID and Student.AdmissionNo=Hosteler.AdmissionNo and Class.ClassName=Section.Class and Student.SchoolID=SchoolInfo.S_ID and Hosteler.Status='Active' order by StudentName", con)
    ...
    Private Sub txtStudentName_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtStudentName.TextChanged
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(Hosteler.H_ID) as [ID],RTRIM(Student.AdmissionNo) as [Admission No.], RTRIM(StudentName) as [StudentName], RTRIM(ClassName) as [Class], RTRIM(SectionName) as Section,RTRIM(SchoolName) as [School Name],RTRIM(HI_ID) as [Hostel ID],RTRIM(HostelName) as [Hostel Name], CONVERT(DateTime,JoiningDate,105) as [Joining Date],RTRIM(Hosteler.Status) as [Status] from Student,Hosteler,HostelInfo,Section,Class,SchoolInfo where Student.SectionID=Section.ID  and HostelInfo.HI_ID=Hosteler.HostelID and Student.AdmissionNo=Hosteler.AdmissionNo and Class.ClassName=Section.Class and Student.SchoolID=SchoolInfo.S_ID and Hosteler.Status='Active' and StudentName like '%" & txtStudentName.Text & "%' order by StudentName", con)
            adp = New SqlDataAdapter(cmd)
            ds = New DataSet()
            adp.Fill(ds, "Student")
            dgw.DataSource = ds.Tables("Student").DefaultView
    ...
    Private Sub txtHostelInfo_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtHostelName.TextChanged
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(Hosteler.H_ID) as [ID],RTRIM(Student.AdmissionNo) as [Admission No.], RTRIM(StudentName) as [StudentName], RTRIM(ClassName) as [Class], RTRIM(SectionName) as Section,RTRIM(SchoolName) as [School Name],RTRIM(HI_ID) as [Hostel ID],RTRIM(HostelName) as [Hostel Name], CONVERT(DateTime,JoiningDate,105) as [Joining Date],RTRIM(Hosteler.Status) as [Status] from Student,Hosteler,HostelInfo,Section,Class,SchoolInfo where Student.SectionID=Section.ID  and HostelInfo.HI_ID=Hosteler.HostelID and Student.AdmissionNo=Hosteler.AdmissionNo and Class.ClassName=Section.Class and Student.SchoolID=SchoolInfo.S_ID and Hosteler.Status='Active'  and HostelName like '%" & txtHostelName.Text & "%' order by StudentName", con)
            adp = New SqlDataAdapter(cmd)
            ds = New DataSet()
            adp.Fill(ds, "Student")
            dgw.DataSource = ds.Tables("Student").DefaultView
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(Hosteler.H_ID) as [ID],RTRIM(Student.AdmissionNo) as [Admission No.], RTRIM(StudentName) as [StudentName], RTRIM(ClassName) as [Class], RTRIM(SectionName) as Section,RTRIM(SchoolName) as [School Name],RTRIM(HI_ID) as [Hostel ID],RTRIM(HostelName) as [Hostel Name], CONVERT(DateTime,JoiningDate,105) as [Joining Date],RTRIM(Hosteler.Status) as [Status] from Student,Hosteler,HostelInfo,Section,Class,SchoolInfo where Student.SectionID=Section.ID  and HostelInfo.HI_ID=Hosteler.HostelID and Student.AdmissionNo=Hosteler.AdmissionNo and Class.ClassName=Section.Class and Student.SchoolID=SchoolInfo.S_ID and Hosteler.Status='Active'  and Session=@d1 and Classname=@d2 and SectionName=@d3 order by StudentName", con)
            cmd.Parameters.AddWithValue("@d1", cmbSession.Text)
            cmd.Parameters.AddWithValue("@d2", cmbClass.Text)
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(Hosteler.H_ID) as [ID],RTRIM(Student.AdmissionNo) as [Admission No.], RTRIM(StudentName) as [StudentName], RTRIM(ClassName) as [Class], RTRIM(SectionName) as Section,RTRIM(SchoolName) as [School Name],RTRIM(HI_ID) as [Hostel ID],RTRIM(HostelName) as [Hostel Name], CONVERT(DateTime,JoiningDate,105) as [Joining Date],RTRIM(Hosteler.Status) as [Status] from Student,Hosteler,HostelInfo,Section,Class,SchoolInfo where Student.SectionID=Section.ID  and HostelInfo.HI_ID=Hosteler.HostelID and Student.AdmissionNo=Hosteler.AdmissionNo and Class.ClassName=Section.Class and Student.SchoolID=SchoolInfo.S_ID and Hosteler.Status='Active'  and JoiningDate between @d1 and @d2 order by StudentName", con)
